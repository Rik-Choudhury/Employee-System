...
public class MainClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("10. Allocate Project to Employee");
        ...
        switch (choice) {
            ...
            case 4: app.filterEmployeeByProject();
            ...
            case 10:app.allocateProjectEmployee();
            break;
    ...
    public void filterEmployeeByLaptop() {
        System.out.println("Enter Employee Laptop Serial number ");
        String sNO =sc.nextLine();
        Employee employee = ops.getEmployeeByLaptop(sNO);
        if (employee != null) {
            printEmployee(employee);
        }
        else {
            System.out.println("No laptop found with serial number "+sNO+", Search Again ");
        }

    }
    public void filterEmployeeByProject() {
        ...
        for (int i = 0; i < postion ; i++) {
            if (allEmployee[i].getProject().equals(projectName)) {
                status = true;
                printEmployee(allEmployee[i]);
            }
        }

        if (!status) {System.out.println("No one currently working on "+projectName+", Search Again ");}
    ...
    public void allocateProjectEmployee() {
        ...
        Employee emp = ops.allocateProject(id,projectName);
    ...
    public void printEmployee(Employee emp) {
        ...
        if (emp.getProject() != null) {
            System.out.println("Currently working on :" + emp.getProject());
        }
        System.out.println("----------------------------------------------------------------------------------");
    }
}//end class
